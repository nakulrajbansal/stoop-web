      ...
      {loading ? (
        ...
        <div className="py-10">
          ...
          <p className="text-[13.5px] text-muted leading-relaxed mb-5 max-w-[400px] mx-auto">
            Nothing here for {cityLabel} this week. Post something you were already going to do and it sits on the
            board until the day passes. The first 50 hosts become Founding members, badge and all.
          </p>
