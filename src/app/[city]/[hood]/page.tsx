...
const LOCAL_COLOR: Record<string, string> = {
  ...
  'lic-waterfront': 'sunset in Gantry Plaza State Park, a walk through Hunter’s Point South Park, coffee near Vernon Boulevard',
  sunnyside: 'coffee on Skillman Avenue, a walk through Sunnyside Gardens, an afternoon in Lou Lodati Park',
  'east-village': 'a loop through Tompkins Square Park, coffee near St. Mark’s Place, a neighborhood garden wander',
  'upper-west-side': 'a Riverside Park walk, coffee near Columbus Avenue, a slow loop along the Central Park reservoir',
  'bed-stuy': 'an afternoon in Herbert Von King Park, coffee near Fulton Street, a brownstone block walk',
