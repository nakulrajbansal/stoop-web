// Tiny inline icons, stroke = currentColor so they inherit text color.
// Replaces raw emoji, which render inconsistently across devices.
...
export function UsersIcon({ size = 14, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      ...
      <path d="M18 14.4c1.8.9 3 2.7 3 4.9" />
    </svg>
  );
}
...
export function NoteIcon({ size = 14, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M8 3h8l4 4v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h2Z" />
